...
(function(){
    ...
    Physics.body = Decorator('body', {
        ...
        init: function( options ){
             ...
             *
             * Properties from the previous refreshTime are stored in:
             * ```javascript
...
(function(){
    ...
    Physics.integrator = Decorator('integrator', {
         ...
         *
         * Integrate bodies by refreshTime.
         *
...
(function(){
    ...
    World.prototype = Physics.util.extend({}, Physics.util.pubsub.prototype, {
        ...
        /** chainable
         * Physics.world#refreshTime( [dt] ) -> Number|this
